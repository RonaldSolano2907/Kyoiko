...
$idMateriaPrincipal = $_GET['idMateriaPrincipal'] ?? null;
$idMateriaPrerrequisito = $_GET['idMateriaPrerrequisito'] ?? null;

if ($idMateriaPrincipal && $idMateriaPrerrequisito) {
...
<head>
    ...
    <title>Eliminar Prerrequisito</title>
    <style>
...
<body>
    ...
    <!-- Mensaje -->
    <h1 style="text-align: center; margin-top: 50px;">Eliminando Prerrequisito...</h1>
