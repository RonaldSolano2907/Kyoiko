...
// Verificar si se ha proporcionado el ID de la materia
$id = $_GET['id'] ?? null;
if ($id) {
    ...
    if (oci_execute($stmt)) {
        ...
        echo "Error al eliminar la materia: " . htmlentities($error['message']);
    }
...
<body>
    ...
    <!-- Mensaje -->
    <h1 style="text-align: center; margin-top: 50px;">Eliminando materia...</h1>
