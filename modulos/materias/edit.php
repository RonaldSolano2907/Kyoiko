...
// Leer datos actuales de la materia
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (oci_execute($stmt)) {
        ...
        echo "Error al actualizar la materia: " . htmlentities($error['message']);
    }
    oci_free_statement($stmt);
}
oci_close($conn);
...
<body>
    ...
    <div class="form-container">
        ...
        <form method="POST">
            ...
            <textarea id="descripcion" name="descripcion" required><?= htmlspecialchars($materia['DESCRIPCION']); ?></textarea>

            <label for="creditos">Créditos:</label>
            <input type="number" id="creditos" name="creditos" value="<?= htmlspecialchars($materia['CREDITOS']); ?>" required>
