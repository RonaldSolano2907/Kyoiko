...
if ($cedula && $idMateria && $semestre && $anio) {
    $sql = "BEGIN PaqueteMatricula.EliminarMatricula(:cedula, :idMateria, :semestre, :anio); END;";
    ...
    if (oci_execute($stmt)) {
        ...
        echo "Error al eliminar la matrícula: " . htmlentities($error['message']);
    }
...
<body>
    ...
    <!-- Mensaje -->
    <h1 style="text-align: center; margin-top: 50px;">Eliminando Matrícula...</h1>
