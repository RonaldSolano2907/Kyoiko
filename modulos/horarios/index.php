...
$sql = "BEGIN PaqueteHorarios.LeerHorario(NULL, :cursor); END;";
...
<body>
    ...
    <div class="table-container">
        ...
        <a href="create.php" class="btn-add">Agregar Horario</a>
        <table>
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                <?php while (($row = oci_fetch_assoc($cursor)) != false): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($row['HORARIOINICIO']); ?></td>
                        <td><?= htmlspecialchars($row['HORARIOFIN']); ?></td>
