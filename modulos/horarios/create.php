...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "BEGIN PaqueteHorarios.CrearHorario(:id_materia, :aula, TO_DATE(:horario_inicio, 'YYYY-MM-DD HH24:MI'), TO_DATE(:horario_fin, 'YYYY-MM-DD HH24:MI'), :dia_semana); END;";
    ...
    if (oci_execute($stmt)) {
        ...
        echo "Error al crear el horario: " . htmlentities($error['message']);
    }
