...
// Verificar si se ha proporcionado el ID del horario
$id = $_GET['id'] ?? null;
if ($id) {
    ...
    if (oci_execute($stmt)) {
        ...
        echo "Error al eliminar el horario: " . htmlentities($error['message']);
    }
...
<body>
    ...
    <!-- Mensaje -->
    <h1 style="text-align: center; margin-top: 50px;">Eliminando horario...</h1>
